package org.yu.study.transactionserver1.transaction.connection;
...
public class YhyConnection implements Connection {
    ...
    public void commit() throws SQLException {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    yhyTransaction.getTask().waitTask();
                    if (yhyTransaction.getTransactionType().equals(TransactionType.commit)) {
                        connection.commit();
                    } else {
                        connection.rollback();
                    }
    ...
    private YhyTransaction yhyTransaction;


    public YhyConnection(Connection connection,YhyTransaction yhyTransaction) {
        this.connection = connection;
        this.yhyTransaction = yhyTransaction;
    }
